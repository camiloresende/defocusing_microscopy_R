...
detachAllPackages <- function() {
  basic.packages <- c("package:pixmap","package:dotCall64","package:grid","package:spam","package:maps","package:tiff","package:rtiff","package:fields","package:stats","package:graphics","package:grDevices","package:utils","package:datasets","package:methods","package:base")
...
plotcell <- function(folder,k,avg_z0,r,avg_z2,area,avg_z4,volume,H,centerH,sphericity,thickprofile,contrast,peaks,rrr,smax,concavity,hmax){
  ...
  segments(38, 5, 88, 5, col= 'yellow',lwd = 3)
  text(64,10,'5 µm', col= 'yellow', cex=1.7)
