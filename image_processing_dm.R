...
folder = '/Users/camil/Desktop/Experimentos/Camilo/2h/'     # Folder containing images to be analyzed
MCHC= 34        # Mean corpuscular hemoglobin concentration obtained from a complete blood count
